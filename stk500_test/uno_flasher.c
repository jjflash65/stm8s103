...
#define mode_sel   PB0                     // Digital 8 bei Arduino
...
#define ledmode_asoutput() led_ddr |= ((1<<ledmode1) | (1<<ledmode2) )
#define ledm1_off()        led_port |= (1<<ledmode1)       // LED ist gegen +Ub geschaltet
#define ledm1_on()         led_port &= (~(1<<ledmode1))

#define ledm2_off()        led_port |= (1<<ledmode2)       // LED ist gegen +Ub geschaltet
#define ledm2_on()         led_port &= (~(1<<ledmode2))

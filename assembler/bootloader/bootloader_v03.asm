...
ramfunction equ 0x0070


.org 0x8000                         ; Startadresse nach dem Einschalten (Resetvektor)
  jpf main

.org 0x9e41                         ; Speicheradresse, ab der der Bootloader im
...
store_64byteblock:
  ; kopiert 64 Bytes von y-indexierten Speicher nach x-inexierten Speicher

  bset FLASH_CR2, #FLASH_CR2_PRG
  bres FLASH_NCR2, #FLASH_NCR2_NPRG
...
main:
  ...
  call progstart_delay

  ; kopiert die Funktion store_64byteblock ins RAM an die
  ; gegebenen Adresse ramfunction

  ldw x,#store_64byteblock
  ldw y,#ramfunction
  ld a,#64
functioncopy:
  push a
